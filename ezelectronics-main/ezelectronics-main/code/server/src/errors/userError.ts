...
class BirthdayError extends Error {
    ...
    constructor() {
        super()
        this.customMessage = "Birthday after today"
        this.customCode = 400
    }
}

export { UserNotFoundError, UserNotManagerError, UserNotCustomerError, UserAlreadyExistsError, UserNotAdminError, UserIsAdminError, UnauthorizedUserError, BirthdayError }